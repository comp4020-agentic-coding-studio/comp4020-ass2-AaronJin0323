...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A doctoral seminar on involution: the discipline of increasing effort " +
    "for decreasing returns, from Geertz's rice paddies to hustle-culture " +
    "LinkedIn posts — taught by a syllabus that keeps escalating.",
  tags: ["satire", "labour", "credentialism"],
