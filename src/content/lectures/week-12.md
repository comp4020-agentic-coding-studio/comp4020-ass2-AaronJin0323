...
description:
  What actually changes, and what doesn't, once you can name the loop
  you're standing on — a wrap-up, not a solution
week: 12
date: 2027-05-24
teachers:
  - aaron-jin
...
- close: this course escalated for twelve weeks, in its workload and in
  its own prose, on purpose; what you do with that noticing is the only
  assignment that was never marked
